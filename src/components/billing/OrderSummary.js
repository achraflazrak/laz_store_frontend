...
export default function OrderSummary({ token }) {
  ...
  return (
    <>
      <Coupon coupon={coupon} setCoupon={setCoupon} applyCoupon={applyCoupon} />
      <ul className="list-group">
          ...
          <li key={index} className="list-group-item d-flex">
            ...
            <div className="d-flex flex-column">
              ...
              <span className="text-muted">
                <i>
                  {lang === "en" ? "Color" : "Couleur"}: {item.color}
                </i>
              </span>
              <span className="text-muted">
                <i>
        ...
        <li className="list-group-item d-flex justify-content-between">
          <span className="fw-bold">
            {lang === "en" ? "Discount" : "Réduction"} ({validCoupon.discount}%)
          </span>
          <span className="fw-normal text-danger">
            ...
            <i
              ...
              className={`bi bi-trash ${!validCoupon.name ? "d-none" : ""}`}
            ></i>
          </span>
          <span className="fw-bold text-danger">-${calcDiscount()}</span>
        </li>
        <li className="list-group-item d-flex justify-content-between">
      ...
      <div className="my-3">
        {validInfos ? (
          <Link to="/order/pay" className="btn btn-primary w-100">
            {lang === "en" ? "Proceed to payment" : "Procéder au paiement"}
          </Link>
        ) : (
