      ...
      <div className="col-md-10 mx-auto">
        <div className="card">
          <div className="card-header bg-white">
            <h4 className="mt-2">{lang === 'en'? 'Reviews' : 'Commentaires'} ({product.reviews.length})</h4>
          </div>
            ...
            {user ? (
              ...
              />
                ...
                <div className="alert alert-info mt-4">
                  {lang === 'en'? 'Please' : 'S\'il vous plaît'} <Link to="/login" className="alert-link">
                    {lang === 'en' ? 'Login' : 'connecter'}
                  </Link> {lang === 'en' ? "to add your review" : "pour ajouter votre commentaire"}
              </div>
            )}
          </div>
        </div>
